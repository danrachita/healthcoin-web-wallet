    ...
    sendType.prototype.sendConfirm = function(amount){
        var self = this, 
            ...
            sendConfirmDialog = new ConfirmationDialog({
                ...
                context: self,
                allowClose: false,
                message: 'You are about to send bio-marker data worth ' + amount + ' HCN, in addition to any fees the transaction may incur (e.g. 0.0001 HCN). Do you wish to continue?',
