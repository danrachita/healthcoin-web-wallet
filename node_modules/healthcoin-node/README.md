# A Node.JS Healthcoin Client!

![Healthcoin](http://static.tumblr.com/ppdj5y9/Ae9mxmxtp/300coin.png)

healthcoin-node is a Healthcoin client for Node.JS. It is a fork of the excellent Healthcoin intended for use with Healthcoin.

* Provide a one-stop resource for the Node.JS developer to get started with Healthcoin integration.
* Prevent would-be Healthcoin web developers worrying whether the Healthcoin client will work out of the box.
* Promote Node.JS development of Healthcoin web apps.
* Identify and address any incompatibilities with the Healthcoin and Healthcoin APIs that exist now and/or in the future.

## Dependencies

You'll need a running instance of [healthcoind](https://github.com/healthcoin/healthcoin) to connect with.

Then, install the healthcoin-node NPM package.

`npm install healthcoin-node`

## Example

```js
var healthcoin = require('healthcoin-node')()

healthcoin.auth('myusername', 'mypassword')

healthcoin.getDifficulty(function() {
...
```js
var healthcoin = require('healthcoin')()
...
TODO: Verify and test with Healthcoin.

The [Healthcoin API](https://github.com/Weltschmerz/Kapitalize#commands) is supported as direct methods. Use either camelcase or lowercase.

```js
healthcoin.getNewAddress(function(err, address) {
...
```js
healthcoin.exec('getNewAddress')

healthcoin.exec('getbalance', function(err, balance) {
...
TODO: Verify and test these with Healthcoin.

All [Healthcoin API](https://en.bitcoin.it/wiki/Original_Healthcoin_client/API_Calls_list) commands are supported, in lowercase or camelcase form.
...
<td> <b>Currently only available on testnet</b> Add a nrequired-to-sign multisignature address to the wallet. Each key is a healthcoin address or hex-encoded public key. If [account] is specified, assign address to [account]. </td>
<td> N
</td></tr>
<tr>
<td> backupwallet </td>
...
<tr>
<td> dumpprivkey </td>
<td> [healthcoinaddress] </td>
<td> Reveals the private key corresponding to <healthcoinaddress< </td>
<td> Y
</td></tr>
<tr>
<td> encryptwallet </td>
...
<td> [account] </td>
<td> Returns the current healthcoin address for receiving payments to this account. </td>
<td> N
</td></tr>
<tr>
...
<td> getgenerate </td>
<td> </td>
<td> Returns true or false whether healthcoind is currently generating hashes </td>
<td> N
</td></tr>
<tr>
...
<td> getnewaddress </td>
<td> [account] </td>
<td> Returns a new healthcoin address for receiving payments.  If [account] is specified (recommended), it is added to the address book so payments received with the address will be credited to [account]. </td>
<td> N
</td></tr>
<tr>
...
<td> [healthcoinaddress] [minconf=1] </td>
<td> Returns the total amount received by <healthcoinaddress< in transactions with at least [minconf] confirmations. While some might consider this obvious, value reported by this only considers *receiving* transactions. It does not check payments that have been made *from* this address. In other words, this is not "getaddressbalance". Works only for addresses in the local wallet, external addresses will always show 0. </td>
<td> N
</td></tr>
<tr>
...
<p>To get a list of accounts on the system, execute healthcoind listreceivedbyaddress 0 true
</p>
</td>
<td> N
</td></tr>
...
<tr>
<td> sendfrom </td>
<td> [fromaccount] [tohealthcoinaddress] [amount] [minconf=1] [comment] [comment-to] </td>
...
<tr>
<td> signmessage </td>
<td> [healthcoinaddress] [message] </td>
...
<td> stop </td>
<td> </td>
<td> Stop healthcoin server. </td>
<td> N
</td></tr>
<tr>
<td> validateaddress </td>
<td> [healthcoinaddress] </td>
<td> Return information about [healthcoinaddress]. </td>
<td> N
</td></tr>
<tr>
<td> verifymessage </td>
<td> [healthcoinaddress] [signature] [message] </td>
...
healthcoin.set('pass', 'somn')
healthcoin.set({port:22555})
