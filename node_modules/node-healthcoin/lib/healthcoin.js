...
Client.prototype = {
        ...
        var req = request(options, function(res) {
            ...
            res.on('end', function() {
                try {
                    ...
                    // statusCode 403 is rpc auth failed. check local healthcoin.conf params.
    ...
    encodeBase64:function(str) {
        if (str) {
            var strBase64 = Buffer.from(str).toString('base64');
        }
        return this;
    },

    decodeBase64:function(strBase64) {
        if (strBase64) {
            var str = Buffer.from(strBase64, 'base64').toString('ascii');
        }
        return this;
    },
