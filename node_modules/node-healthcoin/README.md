...
node-healthcoin is a Healthcoin client for Node.JS. It is a fork of the excellent Healthcoin intended for use with Healthcoin.
...
Then, install the node-healthcoin NPM package.

`npm install node-healthcoin`
