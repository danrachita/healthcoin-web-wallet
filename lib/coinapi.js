...
////if (!isLocal) api.set('rejectUnauthorized', false); // false if using self-signed certificate. TODO: Bring boolean in from settings.json
//api.set('rejectUnauthorized', false); // false if using self-signed certificate. TODO: Bring boolean in from settings.json
api.auth();
