...
biomarkersSchema.methods.buildBiomarker = function(credit, user_id, txcomment, verified, fileData){
	this.header = {
		"version" : "1.0.2",
	...
	for (var i = 0; i < fileData.length; i++){
		// Slurp files into array of BSON objects.
		fileDataBson.push(fs.readFileSync(fileData[i], 'utf8'));
	}
